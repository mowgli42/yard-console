...
C4Component
    ...
    Container_Boundary(dispatcher_boundary, "YARD Dispatcher Service") {
        ...
        Component(beads_tracker, "Beads & OpenSpec Bridge", "Progress Mapper", "Links active beads (`issues.jsonl`) to OpenSpec capability definitions and serves Baseball Card HUD.")
    ...
    Rel(rest_routes, beads_tracker, "Queries bead progression & OpenSpec mappings")
    ...
    Rel(beads_tracker, omarchy_bridge, "Emits active bead trio telemetry")
